 ...
 */
var LSEQIdentGenerator = (function () {
    /**
     ...
     */
    function LSEQIdentGenerator(random, startingWidth, maxDistance) {
    ...
    LSEQIdentGenerator.prototype.getIdent = function (name, time, before, after) {
        ...
        var delta = Math.floor(this.random() * boundary) + 1;
    ...
    LSEQIdentGenerator.prototype.getStrategyAtDepth = function (depth) {
        ...
        if (!strategy) {
            var random = Math.floor(this.random() * 2) + 1;
